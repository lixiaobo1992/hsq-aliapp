...
baseComponent(Component, {
  ...
  watch: {
    skuStocksList(newVal, oldVal) {
      // console.log('skuStocksList', newVal);
  ...
  methods: {
    ...
    getSelectdAttrSkuId() {
      ...
      const newCurrentSkuData = this.props.skuStocksList[currentAttrIds] || {};
    ...
    initSku() {
      ...
      const { attrList = [], skuStocksList = {} } = this.props;
